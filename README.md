...
```sh
git clone git@github.com:iamhrsp/ALU-RISC-V-P-Extension.git
cd ALU-RISC-V-P-Extension
```
...
#### Commit your changes
```sh
git commit -m 'Starting ALU-RISC-V-P-Extension'
...
```sh
mill ALU-RISC-V-P-Extension.test
```
